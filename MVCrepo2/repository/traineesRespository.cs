...

{
...

    {
        ...
        public IEnumerable<UserDetail> GetTrainees()

        {
            InsertViewModel insertViewModel = new InsertViewModel();
            //insertViewModel.

            var userDetails  = DBcontext.UserDetails.ToList();
            insertViewModel.UserDetailsData = userDetails;
